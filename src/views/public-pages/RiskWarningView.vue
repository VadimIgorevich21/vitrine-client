...
<template>
  <div class="public-layout-content">
    <article class="default-container">
      <h1 class="page-title-h1 mb-10">Risk Warning</h1>

      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">Warning on crypto assets</h3>
          <h3 class="page-title-h3 mb-3">Introduction – Crypto-assets can be risky, and your protection, if any, may be limited</h3>
          <p class="page-content-text">
            Not all crypto-assets and crypto-asset services are equal nor are they regulated in the same way (if at all). While a new regulation known as MiCA (the Markets in Crypto-Assets Regulation) is now in place in the EU and regulates activities involving certain crypto-assets, most crypto-assets typically remain volatile and highly risky. As such, they may not be suitable for all consumers as a form of investment, payment or exchange. </p>
          <p class="page-content-text">
          ...
          <p class="page-content-text">
            To better understand the different types of crypto-assets and providers you may encounter take a look at the factsheet Cryptoassets explained: <a href="https://link.europa.eu/BRv4Gn"><strong>What MiCA means for you as a consumer</strong></a>
          </p>
        </div>
      </div>

      <div class="mb-8">
        <h3 class="page-title-h3 mb-3">Summary – what are the key risks you may face?</h3>
        <div class="space-y-4">
          <p class="page-content-text">
      ...
      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">High-Risk Investment</h3>
      ...
      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">Risk of Delisting Crypto Assets</h3>
          <p class="page-content-text">
            Ironbit may delist any crypto asset at its discretion. Delisting may result in losses due to impaired liquidity or inability to transfer assets.
          </p>
          <p class="page-content-text">
            In the event of a delisting, Ironbit will provide reasonable notice where feasible, allowing users to manage their positions accordingly..
          </p>
        </div>
      </div>
      ...
      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">Financial Tolerance and Risk Attitude</h3>
      ...
      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">Technology and Cybersecurity Risks</h3>

          <p class="page-content-text">
            Distributed ledger technologies (DLTs) are evolving and may exhibit operational vulnerabilities.
          </p>
          <p class="page-content-text">
            Ironbit adheres to international cybersecurity standards (ISO 27001 certified) and complies with operational risk and IT management requirements in accordance with Digital Operational Resilience Act (DORA). Despite these efforts, users must be aware that inherent risks associated with blockchain technology and infrastructure may still result in the partial or total loss of crypto assets.
          </p>
          <p class="page-content-text">
            Cyberattacks, theft of private keys, protocol bugs, and system malfunctions can result in irreversible losses. By using Ironbit, you accept the risks related to technology and the internet.
          </p>
          <p class="page-content-text">
            While Ironbit implements robust security measures, in the event of hacking, system vulnerabilities, or other incidents leading to asset loss that are beyond our reasonable control, such events may be considered force majeure events under applicable law, subject to regulatory requirements and mandatory consumer protection provisions.
          </p>
        </div>
      </div>
      ...
      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">Custody and Withdrawal Risks</h3>

          <p class="page-content-text">
            Ironbit ensures the segregation of client assets from company funds, maintaining secure custody of assets. Regular due diligence is conducted on third-party custodians and liquidity providers.
          </p>
          <p class="page-content-text">
            Some crypto assets may be held with third-party liquidity providers who are subject to our due diligence procedures. In these cases, Ironbit will obtain your explicit prior consent and provide detailed information about the arrangement and associated risks before transferring any assets to such providers. While subject to audits, these assets are under third-party control, and Ironbit cannot guarantee equivalent security or accept liability for any resulting loss.
          </p>
        </div>
      </div>
      ...
      <div class="mb-8">
        <div class="space-y-4">
          <h3 class="page-title-h3 mb-3">Fraud and Scam Warnings</h3>

          <p class="page-content-text">
            Ironbit is committed to fraud mitigation and user protection. We do not contact users by phone or through unofficial channels, and we do not employ brokers or agents. We will never ask you for your account credentials or instruct you to install any remote access software on your device.
          </p>
          <p class="page-content-text">
